...
export const projects = [
  {
    ...
    tags: ['React', 'TS', 'Context API', 'Vite', 'FSD'],
  ...
  },
  {
    ...
    image: 'https://mypymypy.github.io/projects-images/vk-groups.webp',
  ...
  },
  {
    ...
    image: 'https://mypymypy.github.io/projects-images/hh-test-weather.webp',
    deploy: 'https://mypymypy.github.io/spb-weather/',
    srcGit: 'https://github.com/MypyMypy/spb-weather',
  },
  {
    name: 'Portfolio Page',
    ...
    tags: ['React', 'TS', 'Redux', 'SPA', 'BEM', 'SCSS', 'FSD'],
  ...
  },
  {
    name: 'Coffee House',
    description:
      'Landing page for a coffee house, made as part of the RSSchool course.',
    date: {
      year: '2023',
      month: '12',
    },
    tags: ['JS', 'BEM', 'CSS3', 'HTML5'],
    deploy:
  ...
  },
  {
    name: 'Nonograms Game',
    tags: ['Game', 'JS', 'CSS3', 'HTML5', 'BEM'],
    description: 'Are picture logic puzzles to reveal a hidden picture.',
    date: {
      year: '2024',
      month: '01',
    },
  ...
  {
    name: 'Pokemons Demo Wiki',
    description: `Wikipedia about Pokemans in demo implementation`,
    date: {
      year: '2023',
      month: '06',
    },
  ...
  {
    name: 'Burger',
    description: `Interface for ordering burgers, made as part of the Udemy course (no deploy)`,
    date: {
      year: '2023',
      month: '03',
    },
  ...
  {
    name: 'Bank Card',
    description: `Bank card validator.`,
    date: {
      year: '2022',
      month: '12',
    },
  ...
  {
    name: 'Guess a Couple',
    description: `My first created game on JS.`,
    date: {
      year: '2022',
      month: '08',
    },
  ...
  },
  {
    name: 'HighPage',
    description:
      'Adaptive landing page with built-in animations and interactive map.',
    date: {
      year: '2022',
      month: '06',
    },
  ...
  {
    name: 'Blanchard',
    description: 'My first adaptive landing page.',
    date: {
      year: '2021',
      month: '06',
    },
  ...
  {
    name: 'GSAP Practice',
    description: 'Landing with some animations using GSAP.',
    date: {
      year: '2022',
      month: '07',
    },
  ...
  {
    name: 'Star Wars',
    description: 'Just Star Wars wiki about first six episodes.',
    date: {
      year: '2022',
      month: '09',
    },
...
export type ProjectsT = typeof projects;
