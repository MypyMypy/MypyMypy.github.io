...
const SortDateButtons: React.FC<SortDateButtonsPropsI> = (
  { sortDateHandler = () => {} },
  activeTopDate
) => {
  ...
  const classNameTopButton = topActive
    ? classNameButton.concat(' ', classNameActiveButtton)
    : classNameButton;
  const classNameDownButton = topActive
    ? classNameButton
    : classNameButton.concat(' ', classNameActiveButtton);
