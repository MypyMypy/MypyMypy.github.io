...
const ControlsProjects: React.FC<ConrolsProjectsPropsI> = ({ className, filterTagsHandler, sortDateHandler, activeTopDate }) => {
    const classes = ['controls'];
    if (className) classes.push(className);

    return (
        <div className={classes.join(' ')}>
            <SortDateButtons sortDateHandler={sortDateHandler} activeTopDate={activeTopDate} />
